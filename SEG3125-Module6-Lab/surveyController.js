...
module.exports = function (app) {
    ...
    app.get('/analysis', function (req, res) {
        ...
        var question5a = readData("question5a");
        var question5b = readData("question5b");
        var question5c = readData("question5c");
        var question6 = readData("question6");
        res.render('showResults', { results: [question1, question2, question3, question4, question5a, question5b, question5c, question6] });
        console.log([question1, question2, question3, question4, question5a, question5b, question5c, question6]);
    });
    ...
    app.post('/niceSurvey', urlencodedParser, function (req, res) {
        ...
        for (var key in json) {
            ...
            if ((key === "question4") && (json[key].length === 2)) {
